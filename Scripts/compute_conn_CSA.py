#######################
#
# This script generates the structural connectome matrix given diffusion data.
#
#######################
...
if os.path.exists("eddycorrected_c.nii.gz"):
   fimg = "eddycorrected_c.nii.gz"
else:
   fimg = "eddycorrected.nii.gz"
...
#Remove noisy connection with less than 3 fibers
#mask = M < 3
#M[mask] = 0

M = (M > 0.0).astype(np.int_)
